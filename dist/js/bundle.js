...
"use strict";
eval("\n\nvar _base = __webpack_require__(/*! ./views/base */ \"./src/js/views/base.js\");\n\nfunction _asyncToGenerator(fn) { return function () { var gen = fn.apply(this, arguments); return new Promise(function (resolve, reject) { function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { return Promise.resolve(value).then(function (value) { step(\"next\", value); }, function (err) { step(\"throw\", err); }); } } return step(\"next\"); }); }; }\n\n$(document).ready(function () {\n\n  //declaring start and end for the page load\n\n  // page:0\n  // start: page x 29 = 0\n  // end: (page + 1) x 29 =29\n\n  // page:1\n  // start: page x 29 = 29\n  // end: (page + 1) x 29 =58\n  /* let start = state.page * 30;\r\n  let end = (state.page + 1) * 30; */\n\n  //get the id of all top stories\n  var getIdOfTopStories = function () {\n    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {\n      var response, data;\n      return regeneratorRuntime.wrap(function _callee$(_context) {\n        while (1) {\n          switch (_context.prev = _context.next) {\n            case 0:\n              _context.next = 2;\n              return fetch(\"https://hacker-news.firebaseio.com/v0/topstories.json?print=pretty\");\n\n            case 2:\n              response = _context.sent;\n              _context.next = 5;\n              return response.json();\n\n            case 5:\n              data = _context.sent;\n              return _context.abrupt(\"return\", data);\n\n            case 7:\n            case \"end\":\n              return _context.stop();\n          }\n        }\n      }, _callee, this);\n    }));\n\n    return function getIdOfTopStories() {\n      return _ref.apply(this, arguments);\n    };\n  }();\n\n  //load all the ids by calling the API\n\n\n  var loadArticles = function () {\n    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(start, end) {\n      var articleIds, currentArticleIds;\n      return regeneratorRuntime.wrap(function _callee3$(_context3) {\n        while (1) {\n          switch (_context3.prev = _context3.next) {\n            case 0:\n              if (start !== 0 && end !== 30) {\n                start = state.page * 30;\n                end = (state.page + 1) * 30;\n              }\n\n              _context3.next = 3;\n              return state.idOfTopStories;\n\n            case 3:\n              articleIds = _context3.sent;\n              _context3.next = 6;\n              return articleIds.slice(start, end);\n\n            case 6:\n              currentArticleIds = _context3.sent;\n              _context3.next = 9;\n              return Promise.all(currentArticleIds.map(function () {\n                var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(articleId) {\n                  var response, articleData;\n                  return regeneratorRuntime.wrap(function _callee2$(_context2) {\n                    while (1) {\n                      switch (_context2.prev = _context2.next) {\n                        case 0:\n                          _context2.next = 2;\n                          return fetch(\"https://hacker-news.firebaseio.com/v0/item/\" + articleId + \".json?print=pretty\");\n\n                        case 2:\n                          response = _context2.sent;\n                          articleData = response.json();\n                          return _context2.abrupt(\"return\", articleData);\n\n                        case 5:\n                        case \"end\":\n                          return _context2.stop();\n                      }\n                    }\n                  }, _callee2, this);\n                }));\n\n                return function (_x3) {\n                  return _ref3.apply(this, arguments);\n                };\n              }()));\n\n            case 9:\n              return _context3.abrupt(\"return\", _context3.sent);\n\n            case 10:\n            case \"end\":\n              return _context3.stop();\n          }\n        }\n      }, _callee3, this);\n    }));\n\n    return function loadArticles(_x, _x2) {\n      return _ref2.apply(this, arguments);\n    };\n  }();\n\n  //function: construct article objects\n\n\n  var renderArticles = function () {\n    var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(start, end) {\n      var articlesLoaded;\n      return regeneratorRuntime.wrap(function _callee4$(_context4) {\n        while (1) {\n          switch (_context4.prev = _context4.next) {\n            case 0:\n              state.page = state.page + 1;\n              _context4.next = 3;\n              return loadArticles(start, end);\n\n            case 3:\n              articlesLoaded = _context4.sent;\n              _context4.next = 6;\n              return Promise.all(articlesLoaded.map(function (article, index) {\n                createViewForItem(article.url, index);\n              }));\n\n            case 6:\n              return _context4.abrupt(\"return\", _context4.sent);\n\n            case 7:\n            case \"end\":\n              return _context4.stop();\n          }\n        }\n      }, _callee4, this);\n    }));\n\n    return function renderArticles(_x4, _x5) {\n      return _ref4.apply(this, arguments);\n    };\n  }();\n\n  //first time, construct article objects for rendering\n\n\n  var createViewForItem = function () {\n    var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(url, counter) {\n      return regeneratorRuntime.wrap(function _callee5$(_context5) {\n        while (1) {\n          switch (_context5.prev = _context5.next) {\n            case 0:\n              $.ajax({\n                type: \"POST\",\n                url: \" https://hackernews-reloaded.herokuapp.com/articles\",\n                data: {\n                  url: url\n                }\n              }).then(function (data) {\n                if (counter % 2 === 0) {\n                  if (data.image) {\n                    var markup = \" <li class=\\\"recent-posts__item\\\">\\n          <figure class=\\\"recent-posts__item--image-container\\\">\\n              <img src=\\\"\" + data.image + \"\\\"\\n                  alt=\\\"\\n              recent-posts-image\\\" class=\\\"recent-posts__item--image\\\">\\n          </figure>\\n          <div class=\\\"recent-posts__item--content\\\">\\n              <div class=\\\"posts__header\\\">\\n                  Money Diaries\\n              </div>\\n              <div class=\\\"posts__title\\\">\\n                  \" + data.title + \"\\n              </div>\\n              <div class=\\\"posts__content\\\">\\n                  \" + data.description + \"\\n              </div>\\n          </div>\\n      </li>\";\n                    _base.elements.recentPostListRight.insertAdjacentHTML(\"beforeend\", markup);\n                  } else {\n                    var _markup = \" <li class=\\\"recent-posts__item\\\">\\n          <figure class=\\\"recent-posts__item--image-container\\\">\\n              <img src=\\\"https://wealthsimple-grow.ghost.io/content/images/2018/10/NatashaRothwell_final.jpg\\\"\\n                  alt=\\\"\\n              recent-posts-image\\\" class=\\\"recent-posts__item--image\\\">\\n          </figure>\\n          <div class=\\\"recent-posts__item--content\\\">\\n              <div class=\\\"posts__header\\\">\\n                  Money Diaries\\n              </div>\\n              <div class=\\\"posts__title\\\">\\n                  Natasha Rothwell Plays an Accountant on 'Insecure.' Her Real Life Wasn't So\\n                  Excel-Ready.\\n              </div>\\n              <div class=\\\"posts__content\\\">\\n                  A Money Diary about subsidized housing, writing for 'Saturday Night Live,' and\\n                  getting\\n                  into\\n                  credit card debt from the actress ('Love, Simon') and writer.\\n              </div>\\n          </div>\\n      </li>\";\n                    _base.elements.recentPostListRight.insertAdjacentHTML(\"beforeend\", _markup);\n                  }\n                } else {\n                  if (data.image) {\n                    var _markup2 = \" <li class=\\\"recent-posts__item\\\">\\n          <figure class=\\\"recent-posts__item--image-container\\\">\\n              <img src=\\\"\" + data.image + \"\\\"\\n                  alt=\\\"\\n              recent-posts-image\\\" class=\\\"recent-posts__item--image\\\">\\n          </figure>\\n          <div class=\\\"recent-posts__item--content\\\">\\n              <div class=\\\"posts__header\\\">\\n                  Money Diaries\\n              </div>\\n              <div class=\\\"posts__title\\\">\\n                  \" + data.title + \"\\n              </div>\\n              <div class=\\\"posts__content\\\">\\n                  \" + data.description + \"\\n              </div>\\n          </div>\\n      </li>\";\n                    _base.elements.recentPostListLeft.insertAdjacentHTML(\"beforeend\", _markup2);\n                  } else {\n                    var _markup3 = \" <li class=\\\"recent-posts__item\\\">\\n          <figure class=\\\"recent-posts__item--image-container\\\">\\n              <img src=\\\"https://wealthsimple-grow.ghost.io/content/images/2018/10/NatashaRothwell_final.jpg\\\"\\n                  alt=\\\"\\n              recent-posts-image\\\" class=\\\"recent-posts__item--image\\\">\\n          </figure>\\n          <div class=\\\"recent-posts__item--content\\\">\\n              <div class=\\\"posts__header\\\">\\n                  Money Diaries\\n              </div>\\n              <div class=\\\"posts__title\\\">\\n                  Natasha Rothwell Plays an Accountant on 'Insecure.' Her Real Life Wasn't So\\n                  Excel-Ready.\\n              </div>\\n              <div class=\\\"posts__content\\\">\\n                  A Money Diary about subsidized housing, writing for 'Saturday Night Live,' and\\n                  getting\\n                  into\\n                  credit card debt from the actress ('Love, Simon') and writer.\\n              </div>\\n          </div>\\n      </li>\";\n                    _base.elements.recentPostListLeft.insertAdjacentHTML(\"beforeend\", _markup3);\n                  }\n                }\n                return data;\n              });\n\n            case 1:\n            case \"end\":\n              return _context5.stop();\n          }\n        }\n      }, _callee5, this);\n    }));\n\n    return function createViewForItem(_x6, _x7) {\n      return _ref5.apply(this, arguments);\n    };\n  }();\n\n  var state = {\n    page: -1\n  };state.idOfTopStories = getIdOfTopStories();\n\n  renderArticles(0, 30);\n\n  var doit;\n  $(window).scroll(function () {\n    var hT = $(\".load-more-posts\").offset().top,\n        hH = $(\".load-more-posts\").outerHeight(),\n        wH = $(window).height(),\n        wS = $(this).scrollTop();\n    if (wS > hT + hH - wH) {\n      clearTimeout(doit);\n      doit = setTimeout(renderArticles, 2000);\n    }\n  });\n});\n\n//# sourceURL=webpack:///./src/js/index.js?");
...
"use strict";
eval("\n\nObject.defineProperty(exports, \"__esModule\", {\n  value: true\n});\nvar elements = exports.elements = {\n  recentPostListLeft: document.querySelector(\".recent-posts__list--left\"),\n  recentPostListRight: document.querySelector(\".recent-posts__list--right\")\n};\n\n//# sourceURL=webpack:///./src/js/views/base.js?");
